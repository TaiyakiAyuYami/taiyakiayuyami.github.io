    ...
    this.innerHTML = `
      <header>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
          ...
          <symbol id="bi-location" viewBox="0 0 16 16">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <div class="container-fluid">
            <a class="navbar-brand" href="/"><img src="/assets/icon-ayu-yami.webp" alt="Ayu-Yami icon" width="30" height="auto" loading="eager" fetchpriority="high" decoding="sync">  Taiyaki Ayu-Yami</a>
